...
`index.html`, `iphone.html`, `test.html`, `after-green.html`, `agy-worked.html`, and `grok-worked.html` are deployed to GitHub Pages. Shared menu is `nav.js`. If you change how the environment works, update those pages and `tests/test_system.py`.
