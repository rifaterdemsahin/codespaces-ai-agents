...
echo "    ./scripts/system-test.sh -v          # repo + Pages + vault if logged in"
echo "    ./scripts/system-test.sh --live -v   # after grok login: model must print READY"
echo "    See SUBSCRIPTION.md and https://rifaterdemsahin.github.io/codespaces-ai-agents/test.html"
